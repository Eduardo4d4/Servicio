...
def mostrar_resultados():
    ...
    label_alcaldias.config(text="Las top 5 alcaldías con mayor población para el sexo {} y edad {} son:\n{}".format(sexo, edad, top_alcaldias))
    ...
    label_propo.config(text=relacion_hombre_mujer_text)
...
# Etiqueta para mostrar proporcion
label_propo = ttk.Label(window, text="")
label_propo.pack()
...
# Etiqueta para mostrar la información económica
label_economia = ttk.Label(window, text="")
label_economia.pack()

# Etiqueta para mostrar los resultados
label_resultados = ttk.Label(window, text="")
